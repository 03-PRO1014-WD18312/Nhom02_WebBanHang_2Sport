                        ...
                        echo '
                            <div class="right_order">
                                ...
                                <form class="payment-in" method="POST" target="_blank" enctype="application/x-www-form-urlencoded" action="view/payment_atm.php">
                                    <input type="text" name="tongtien_order" value="' . $sum . '">
                                    <h5><i class="fa-solid fa-credit-card"></i> HÌNH THỨC THANH TOÁN <a href="index.php?act=setInfoUser"><i class="fa-solid fa-square-pen" style="font-size:15px; color:#BD0000;"></i></a></h5> 
                                    <div class="payout-in">
                                        <select class="select-payment" name="payment_method" disabled id="">
                                            <option value="0">💵 Thanh toán bằng tiền mặt</option>
                                            <option value="1" selected>🏧 Thanh toán bằng ATM MOMO</option>
                                        </select>
                                        <input type="submit" name="payment_atm" value="THANH TOÀN BẰNG MOMO">
                                    </div>
                                </form>
                            </div>
                        ';
